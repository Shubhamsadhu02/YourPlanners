        ...
        <>
            <section>
                <div className="container">
                    ...
                    <div className=" inline-table md:grid md:grid-cols-12">
                        <div className="flex flex-col md:col-span-3 border-2 mr-2 shadow-inner inset-y-4 bg-white w-[350px] md:w-full">
                            ...
                            <button type="submit" className="p-2 md:p-3 text-sm md:text-base"
                                id={"appointment"} onClick={handleTabClick} style={currentTab === 'appointment' ? activeTabStyle : inactiveTabStyle}>Present Appointments</button>

                        </div>
                        <div className="w-[350px] md:w-full md:col-span-9 content p-4 border-2 border-b-0 rounded-[10px] shadow-inner inset-y-4 flex justify-center bg-white ">
                            {
                                ...
                                <>
                                    <div class="relative overflow-x-auto">
                                        <table className="w-full divide-y divide-gray-200 md:table-fixed">
                                            ...
                                            {plannerItems?.filter((n) => n.isVerified === false).length === 0 ? (
                                                    <tr>
                                    ...
                                    <div className=" grid md:flex flex-col items-center">
                                        ...
                                        <div class="relative overflow-x-auto">
                                            <table className="w-full divide-y divide-gray-200 md:table-fixed">
                                                ...
                                                <tbody className="bg-white divide-y divide-blue-200">
                                                {plannerItems?.filter((n) => n.isVerified === true).length === 0 ? (
                                                    <tr>
                                                        <td colSpan="6" className="text-center py-4">
                                                            No data found.
                                                        </td>
                                ...
                                <>
                                    <div class="relative overflow-x-auto">
                                        <table className="w-full divide-y divide-gray-200 md:table-fixed">
                                            ...
                                            <tbody className="bg-white divide-y divide-blue-200">
                                            {appointmentItems?.filter((n) => n.isDone === true).length === 0 ? (
                                                    <tr>
                                                        <td colSpan="6" className="text-center py-4">
                                                            No data found.
                                                        </td>
                                                ...
                                                appointmentItems?.filter((n) => n.isDone === true)
                                                    .map((item, index) => (
                                                        <tr key={item?.id}>
                                                            ...
                                                            <td className='px-6 py-4 whitespace-nowrap capitalize'>{item.vRegister}</td>
                                                            <td className='px-6 py-4'><motion.div
                                                                whileTap={{ scale: 0.99 }}
                                                                className="cursor-pointer"
                                                                onClick={() => {
                                ...
                                <>
                                    <div class="relative overflow-x-auto">
                                        <table className="w-full divide-y divide-gray-200 md:table-fixed">
                                            ...
                                            <tbody className="bg-white divide-y divide-blue-200">
                                                {appointmentItems?.filter((n) => n.isDone === false).length === 0 ? (
                                                    <tr>
                                                        <td colSpan="6" className="text-center py-4">
                                                            No data found.
                                                        </td>
                                                    ...
                                                    appointmentItems?.filter((n) => n.isDone === false)
                                                        .map((item, index) => (
                                                            <tr key={item?.id}>
                                                                <td className='px-6 py-4 capitalize break-words'>{item.fullName}</td>
                                                                <td className='px-6 py-4 w-24 capitalize break-words'>{item.contactNo}</td>
                            ...
                            {openCustomer && (
                                <CustomerDetails setOpenCustomer={setOpenCustomer} data={selectedCustomer} />
                            )}
                        </div>
                    </div>
                </div>
